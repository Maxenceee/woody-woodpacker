...
db  15, 14, 13, 12, 11, 10, 9, 8, 15, 14, 13, 12, 11, 10, 9, 8
...
psrldq 	xmm0,	4
movdqa 	xmm2,	xmm0
pshufb 	xmm2,	[LOAD_HIGH_BROADCAST_AND_BSWAP]
paddq 	xmm2,	[TWO_N_ONE]
movdqa 	xmm1,	xmm2
paddq 	xmm2,	[TWO_N_TWO]
pshufb 	xmm1,	[BSWAP_EPI_64]
pshufb 	xmm2,	[BSWAP_EPI_64]
shr 	r8,	2
je 	REMAINDER_4
sub 	rsi,	64
sub 	rdi,	64
