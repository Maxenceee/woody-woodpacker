...
#define WD_PAYLOAD_OFF_DATA_START (24) // 3 * sizeof(uint64_t) + sizeof(aes_key) + sizeof(uint32_t)
#define WD_PAYLOAD_OFF_DATA_SIZE (16) // 3 * sizeof(uint64_t) + sizeof(aes_key) + sizeof(uint32_t)
